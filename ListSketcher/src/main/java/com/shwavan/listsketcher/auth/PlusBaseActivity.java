...
public abstract class PlusBaseActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlusClient = new PlusClient.Builder(this, this, this)
                ...
                .setScopes(Scopes.PLUS_LOGIN, Scopes.PLUS_ME)  // recommended login scope for social features
    ...
    public void signOut() {
        ...
        if (mPlusClient.isConnected()) {
            ...
            ParseUser.logOut();
            SQLiteListsHelper helper = new SQLiteListsHelper(getApplicationContext());
            helper.clearDB();
    ...
    public void parseLogin() {
        if (ParseUser.getCurrentUser() == null) {
            ...
            if (cd.isConnectingToInternet()) {
                Log.e("parseLogin", "Parse Login running");
                sessionManager = new SessionManager(this);
                final ParseUser guser = new ParseUser();
                String email = sessionManager.getKeyEmail();
                final String username = email.substring(0, email.length() - 10);
                guser.setUsername(username);
                final String client_id = sessionManager.getKeyPlusProfileId();
                guser.setPassword(client_id);
                guser.setEmail(email);
                guser.put("name", sessionManager.getName());

                guser.signUpInBackground(new SignUpCallback() {
                ...
                ParseUser.logInInBackground(username, client_id, new LogInCallback() {
                    @Override
                ...
                Log.e("Parse Login", "Couldn't connect to the internet!");
            }
        }
    }
